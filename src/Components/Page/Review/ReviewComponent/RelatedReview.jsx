...
const RelatedReview = () => {
    ...
    const RelatedReview = [
        ...
        },
        {
            ...
            review: "Good peeps. Happy vibes. Smart pharmacists. My crew!Good peeps. Happy vibes. Smart pharmacists. My crew!Good peeps. Happy vibes. Smart pharmacists. My crew!",
            footer_h1: "Help", footer_h2: "Report"
        }]
    return (
        <>
                        ...
                        <div className=" col-sm-8 col-10 border related_review_container mt-4" key={index}>
                            <div className="row">
                                ...
                                <div className="col-9 col-sm-10 related_review_content">
                                    <div className="row">
                                        <div className="col-12 RelatedReview_TextCol_height fontStyle related_review_heading ellipsis">
                                            <p>{ele.head}</p>
                                        ...
                                        <div className='col-12 RelatedReview_TextCol_height related_review_Comment ellipsis'>
                                           <p>{ele.review}</p>
                                        </div>
