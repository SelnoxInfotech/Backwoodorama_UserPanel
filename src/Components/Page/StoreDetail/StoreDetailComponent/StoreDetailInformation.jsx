                        ...
                        <div className="row">
                            ...
                            <div className="col-12  store_content_middle_Content">
                                <p>
                                    ...
                                    marijuana online. Fastest delivery with curbside and store pickup.
                                </p>
                            </div>
                            <div className="col-12 store_content_middle_Content">
                                <p>
                                    LeaflyweedNYC is the best place to buy marijuana online and
                                    get the best delivery services in New York. Leaflyweednyc
                                    weed delivery services NYC is the best place to buy your
                                    favourite marijuana online. Fastest delivery with curbside
                                    and store pickup.
                                </p>
                            </div>
