                                ...
                                <div className="row mt-2" key={index}>
                                    <div className="col-lg-12  col-md-12 col-sm-12 col-12 despensories_card_container">
                                        <div className="row">
                                           ...
                                           <Link to={`/DispensoriesProduct/${ele.id}/${"Menu"}`}>     <LazyLoadImage id={ele.id} src={`https://backend.sweede.net/${ele.Store_Image}`} alt="img_not_found" className="dispensories_card_image" /></Link>
