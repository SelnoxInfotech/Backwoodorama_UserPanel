                                ...
                                <div className={readmore ? "related_verify_paragraph" : " brandMoreLess" }>
                                    ...
                                    <div 
                                     ...
                                     {{ __html: readmore ?  BrandDetails.Brand_description +
                                      ` <span id="band_shlebtn"  class="band_shlebtn"  onclick='dosomething();' > Read less</span>` :
                                        BrandDetails.Brand_description.split('</p>')[0] + `<span onclick='dosomething();' class="band_shlebtn" >  Read More</span>` } }  />
