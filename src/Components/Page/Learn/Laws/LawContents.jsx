const USA = [
    {
        ...
        // {
        //     title: "Introduction",
        //     content: <p>In the southeastern corner of the United States, Alabama stands as a state known for its rich history and cultural tapestry. However, when it comes to marijuana, the state's legal landscape is not as diverse. It sheds light on Alabama's marijuana laws, exploring its legality,
        //         legislative journey, possession limits, purchasing options, consumption restrictions, lab testing protocols.</p>
