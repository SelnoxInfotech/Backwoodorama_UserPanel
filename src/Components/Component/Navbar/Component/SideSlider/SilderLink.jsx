        ...
        <Grid container spacing={2}  >
          ...
          <Grid xs={6} md={2} xl={2} display={{ xs: "none", md: "block", lg: "block" }}>
            <div className=' col-12 Login_Sigup_button Login_Sigup_logo ' >
              <a target="_blank" href={"https://www.facebook.com/profile.php?id=61550742531174"}><ImFacebook color={"#39569c"} size={25} ></ImFacebook></a>
              <a target="_blank" href={"https://www.instagram.com/weedx_io"}> <RiInstagramLine className="InstaColor" size={25} ></RiInstagramLine></a>
              <a target="_blank" href={'https://www.linkedin.com/company/weedx-io/'}> <BsLinkedin size={22} color='#0072b1' ></BsLinkedin></a>
