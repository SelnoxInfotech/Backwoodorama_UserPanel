            ...
            {GetApiData.map((items, index) => {
                return (
                    <React.Fragment key={index}>
                        <div className="col_xl_width col-lg-4 col-md-5 col-sm-6 col-12" >
                            <div className="col-12 whislistCard">
                                ...
                                <div className="col-12 whislistImgCenter">
                                    <div className="whislist_innerImgContainer">
                                        <LazyLoadImage src="./image/cat_pro_7.jpg" className="whislist_imageStyle border" alt="imgs-not-found" onClick={()=>Navigate(`/NewProductDetails/${items.product}`)} />
                                    </div>
                                </div>
                                <div className="col-12 whislistCard_Content_Container">
                                    ...
                                    <div className="WhishListCard_paddingLeft">
                                        <p className="whislistAddress multine-ellipsis">Tyonek Alaska  | 110 mi errrrrrrrrrrrrrrrrrrrrrrrrrrrrr errrrrrrrrrrrrrr</p>
                                    </div>
